import{d,u as _,a as u,c as m,b as p,o as a,e as l,f as t,t as s,g as r,F as h,r as f,n as g,h as v,i as x,j as b,k as y,l as N,m as k,_ as P}from"./index-QsELcgZi.js";import{N as w}from"./NoteDisplay-AWmt4WfG.js";const V={class:"m-4"},D={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},S={class:"opacity-50"},T={class:"text-lg"},j={class:"font-bold flex gap-2"},B={class:"opacity-50"},F=t("div",{class:"flex-auto"},null,-1),H={key:0,class:"border-gray-400/50 mb-8"},z=d({__name:"PresenterPrint",setup(C){_(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
